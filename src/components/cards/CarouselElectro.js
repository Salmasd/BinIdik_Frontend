...
import cover2 from "../../images/menager.jpeg";
import { color } from '@mui/system';


export class CarouselElectro extends Component {
    render() {
        return (
            <div className="cover">
                <Carousel>
                    ...
                    <Carousel.Item interval={6000}>
                        ...
                        <div style={{  backgroundColor: "rgba(0, 0, 0,0.65)", fontSize: "35px"}} ><br/>
                         <b><p>Trouvez Votre expert reconnu pour le dépannage d'Electroménager</p></b>
                        <br/>
                        </div>
                        <br/><br/><br/><br/><br/>
                        </Carousel.Caption>
            ...
            export default CarouselElectro;