...
import logement from "../../images/mrbrico2.jpg";
...
export default function SignUpSide() {
  ...
  const handleSubmit = async (e) => {
    ...
    try{
      ...
      let data= {email,mdp,nom,prenom,role,telephone};
      console.log(data);
    ...
    <ThemeProvider theme={theme}>
      <Grid container component="main" sx={{ height: '110vh' }}>
        ...
        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
          ...
          >
            <Avatar shape="square" size={150} src={<Image src={logo} style={{ width: 140, height:150 }} />} />    
